...
export const EXERCISES = {
    barbell_bench_press: {
        ...
        url:'https://youtu.be/rT7DgCr-3pg?si=sFTkcLdcaiX4hb09'
    ...
    prayer_press: {
        ...
        url:'https://youtu.be/htTc6LFZjpo?si=Mm-2eyCfPatFrlWg'
    },
    pec_dec: {
        type: 'accessory',
        meta: {
        ...
        url:'https://youtu.be/Z57CtFmRMxA?si=Gk4WIfdg6QKa5-A6'
    },
    standing_dumbbell_incline_fly: {
        ...
        url:'https://youtu.be/XSdcma4EIWs?si=Ps2evP4jN9-nYo0-'
    },
    standing_plate_raises: {
        ...
        url:'https://youtu.be/_DWz24dhDvM?si=WpmarEHp7OOO5Zc0'
    },
    cable_fly: {
        type: 'accessory',
        meta: {
        ...
        url:'https://youtu.be/PgxM-u6pPOY?si=JSgoV8-Cjav6NmjX'
    },
    pushup: {
        type: 'accessory',
        meta: {
        ...
        substitutes: ['pushups', 'dumbbell bench press', 'floor press'],
        url:'https://youtu.be/m1W1BGpPGMo?si=lxJzSA-7rcQHksrg'
    },
    dips: {
        type: 'compound',
        meta: {
        ...
        url:'https://youtu.be/2z8JmcrW-As?si=ya9x_je2NkFPuTcp'
    },
    ...
    dumbbell_bench_press: {
        ...
        url:'https://youtu.be/QsYre__-aro?si=iXCjMihG1mMkP7nT'
    },
    // decline_pushup: {
    //     type: 'accessory',
    //     meta: {
    ...
    landmine_press: {
        ...
        url:'https://youtu.be/otfoiGhf-QQ?si=k0HvvKwGZW5mp7vR'
    },
    chest_press: {
        type: 'accessory',
        meta: {
        ...
        url:'https://youtu.be/xUm0BiZCWlQ?si=GTxnu_H3QzCCd9lD   '
    },
    ...
    smith_machine_press: {
        ...
        url:'https://youtu.be/4hjC4VawkAY?si=dd4GmKawF4LsWpqo'
    },
    ...
    unilateral_cable_press: {
        ...
        url:'https://youtu.be/-ZkiF-kHPXo?si=Bj-KP1JOzO-YL_b6'
    },
    cable_crossover_press: {
        ...
        url:'https://youtu.be/xr54nDwKDlc?si=i2c1Op6fOpEOigO0'
    },
    scapula_pushup: {
        type: 'accessory',
        meta: {
        ...
        substitutes: ['pushup'],
        url:'https://youtu.be/fLAf2YG4flw?si=AwT19m8kvv7IcIgW'
    },
    dumbbell_chest_fly: {
        type: 'accessory',
        meta: {
        ...
        url:'https://youtu.be/QENKPHhQVi4?si=V_I8y8qZBzPQcfVB'
    },
    dumbbell_floor_press: {
        ...
        url:'https://youtu.be/lNdi7VEf2Ew?si=pM1YDC7kbHOnrQCR'
    },
    barbell_floor_press: {
        type: 'compound',
        meta: {
        ...
        url:'https://youtu.be/9vYCwtHkWgI?si=F3A7TCAPkJxO5oyp'
    },
    dumbbell_pullover: {
        type: 'accessory',
        meta: {
        ...
        substitutes: ['Inclined dumbbell fly'],
        url:'https://youtu.be/FK4rHfWKEac?si=34_j4t3UbwW72sU1'
    },
    pullup: {
        type: 'compound',
        meta: {
        ...
        url:'https://youtu.be/iqwaby3dZxU?si=nCdFiLQ0Gt0SmuKC'
    },
    lat_pulldown: {
        type: 'compound',
        meta: {
        ...
        url:'https://youtu.be/dWaklWxVPvw?si=0KvzGgKMtCtYMwbm'
    },
    straight_arm_pushdown: {
        ...
        url:'https://youtu.be/aXTKdnCIyWA?si=QNjbvGldekXM_TPU'
    },
    kneeling_lat_pulldown: {
        ...
        substitutes: ['pullup', 'kneeling lat pushdown'],
        url:'https://youtu.be/6Rh_F5Zk0MA?si=aBGACVfdG6oiVPtA'
    },
    one_arm_pulldown: {
        type: 'accessory',
        meta: {
        ...
        substitutes: ['pullup', 'kneeling lat pushdown'],
        url:'https://youtu.be/HBC5s98wXko?si=-Vl4J3ozUJSjmSo5'
    },
    barbell_bentover_row: {
        ...
        url:'https://youtu.be/6FZHJGzMFEc?si=E0u8jipZkqAn1A6_'
    },
    dumbbell_bentover_row: {
        ...
        substitutes: ['seated row', 'dumbbell row'],
        url:'https://youtu.be/5PoEksoJNaw?si=4dJOqWtoNT5tbAz0'
    },
    pendlay_row: {
        type: 'accessory',
        meta: {
        ...
        url:'https://youtu.be/EzFkN5ge5_k?si=yJUV9oJ3AhXCDnUH'
    },
    bodyweight_row: {
        type: 'accessory',
        meta: {
        ...
        substitutes: ['seated row', 'barbell row'],
        url:'https://youtu.be/bHO0A4ZF_Zg?si=tkXFmzWqRRpGSyPf'
    },
    tbar_row: {
        type: 'compound',
        meta: {
        ...
        substitutes: ['seated row', 'dumbbell row'],
        url:'https://youtu.be/aoMlyY_aMIc?si=81bo5opu01MmgjRs'
    },
    seated_row: {
        type: 'accessory',
        meta: {
        ...
        url:'https://youtu.be/UCXxvVItLoM?si=BWy6bHkSh3GXZFmC'
    },
    unilateral_seated_row: {
        ...
        substitutes: ['seated row', 'dumbbell row'],
        url:'https://youtu.be/phDt7p-4WzM?si=pfxOFqWUwbgbIgf-'
    },
    cable_row: {
        type: 'accessory',
        meta: {
        ...
        url:'https://youtu.be/UCXxvVItLoM?si=TBtFG5VKC2ViAjG1'
    },
    ...
    face_press: {
        ...
        url:'https://youtu.be/rep-qVOkqgk?si=YHjFAnVZ7K_KgoDF'
    },
    ...
    tricep_dip: {
        ...
        substitutes: ['rope cable pushdown'],
        url:'https://youtu.be/0326dy_-CzM?si=h_yZOlZIhvfeLR8H'
    },
